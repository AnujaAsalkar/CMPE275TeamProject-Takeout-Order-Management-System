...
<div id="secondSection" align="center">
 ...
 <div class="row container-fluid" style="margin-top:300px">
    <div id="leftSection" class="col-md-4"></div>
      <div name="middleSection" class="col-md-4">
        <h3 style="color: #7ddc27;" align="center">User Login</h3>
        ...
        <h3 style="color:#459cdc;"><input type="text"  class="form-control"value="${msg}" readonly="readonly" style="width: 300px; color:red; background-color: transparent; border:none"/></h3>
	
 </form>
        <div text-align="center">
	<form align="center" >
	<h2 style="color:blue">Don't have account?</h2>
